...
(function() {
   ...
   */
   // Toggle the mobile nav menu when the toggle button is clicked
...
async function updateCounter() {
  let response = await fetch("https://fnl5tkt2s6wwxaxvbpf43rcoi40lvuqr.lambda-url.eu-west-2.on.aws/");
